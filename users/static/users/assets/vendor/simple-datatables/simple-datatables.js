            ...
            (function (global) {
                (function () {
                    ...
                    var w = function (t) {
                        ...
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = E(s.length, !1), a = E(i.length, !1), o = [], r = function () {
                            ...
                            var t = function (t, e, s, i) {
                                ...
                                for (var h = 0; h < o; h++) for (var p = t[h], f = 0; f < r; f++) {
                                    var m = e[f];
                    ...
                    function k(t, e) {
                        ...
                        if (f(t, "Text", "Comment")) s.data = t.data; else {
                    ...
                    var P = {
                        ...
                        for (var o = new RegExp(A), r = null, l = !1; !l;) if (null === (r = o.exec(t))) l = !0; else if (r[0].trim()) if (r[1]) {
                            var d = r[1].trim(), c = [d, ""];
                        ...
                        return t.prototype.init = function () {
                            ...
                            for (var a, o, r, l, d, c = function (t, e, s) {
                                var i = t.childNodes ? E(t.childNodes.length, !0) : [],
                                    n = e.childNodes ? E(e.childNodes.length, !0) : [], a = 0;
                                return s.forEach((function (t) {
                                    for (var e = t.oldValue + t.length, s = t.newValue + t.length, o = t.oldValue; o < e; o += 1) i[o] = a;
                                    for (o = t.newValue; o < s; o += 1) n[o] = a;
                                    a += 1
                                })), {gaps1: i, gaps2: n}
                            }(t, e, s), h = c.gaps1, u = c.gaps2, f = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(h.length, u.length), b = [], v = 0, _ = 0; v < g; _ += 1, v += 1) if (!n || !0 !== h[v] && !0 !== u[v]) {
                                if (!0 === h[_]) if ("#text" === (l = f[_]).nodeName) if ("#text" === m[v].nodeName) {
                                    if (l.data !== m[v].data) {
                                        for (var w = _; f.length > w + 1 && "#text" === f[w + 1].nodeName;) if (w += 1, m[v].data === f[w].data) {
                                            d = !0;
                                            break
                                        }
                    ...
                    const F = (t, e, s, {
                        ...
                        rowRender: g,
                        tabIndex: b
                    }, {noColumnWidths: v, unhideHeader: _, renderHeader: w}, y, D) => {
                        const M = {
                    ...
                    var z = {exports: {}}, U = B(z.exports = function () {
                        ...
                        w[_] = g;
                        var y = "$isDayjsObject", D = function (t) {
                        ...
                        var O = function () {
                            ...
                            return b.parse = function (t) {
                                ...
                                var s = this, i = !!x.u(e) || e, c = x.p(t), p = function (t, e) {
                                ...
                                var s, l = x.p(t), c = "set" + (this.$u ? "UTC" : ""),
                                ...
                                var i = t || "YYYY-MM-DDTHH:mm:ssZ", n = x.z(this), a = this.$H, o = this.$m,
                                ...
                                var f, m = this, g = x.p(u), b = N(i), v = (b.utcOffset() - this.utcOffset()) * e,
                                    _ = this - b, w = function () {
                                        return x.m(m, b)
                                    };
                                switch (g) {
                    ...
                    }()), J = {exports: {}}, W = B(J.exports = function () {
                        var t = {
                                LTS: "h:mm:ss A",
                                LT: "h:mm A",
                                L: "MM/DD/YYYY",
                    ...
                    const Q = (t, e) => {
                        ...
                        if (t.headings) o.headings = t.headings.map((t => Z(t))); else if (e?.tHead) o.headings = Array.from(e.tHead.querySelectorAll("th")).map(((t, e) => {
                            const o = (t => {
                            ...
                            cells: Array.from(t.cells).map(((t, e) => {
                                const i = t.dataset.content ? X(t.dataset.content, s[e]) : ((t, e) => {
                                    ...
                                    switch (e.type) {
                                        ...
                                        default:
                                            s = {
                                                data: k(t, {valueDiffing: !1}).childNodes || [],
                                                text: t.innerText,
                                                order: t.innerText
                                            }
                                    }
                    ...
                    exports.DataTable = class {
                        ...
                        constructor(t, e = {}) {
                            ...
                            const i = {...et.diffDomOptions, ...e.diffDomOptions}, n = {...et.labels, ...e.labels},
                            ...
                            this.options = {
                                ...
                                labels: n,
                                classes: a
                            }, this._initialHTML = this.options.destroyable ? s.outerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new j(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }

                        init() {
                            if (this.initialized || d(this.dom, this.options.classes.table)) return !1;
                            this._virtualDOM = k(this.dom, this.options.diffDomOptions || {}), this._tableAttributes = {...this._virtualDOM.attributes}, this._tableFooters = this._virtualDOM.childNodes?.filter((t => "TFOOT" === t.nodeName)) ?? [], this._tableCaptions = this._virtualDOM.childNodes?.filter((t => "CAPTION" === t.nodeName)) ?? [], void 0 !== this.options.caption && this._tableCaptions.push({
                                nodeName: "CAPTION",
                        ...
                        _renderSeparateHeader() {
                            ...
                            let e = {
                                ...
                                childNodes: [{
                                    nodeName: "THEAD",
                                    childNodes: [F(this.data.headings, this.columns.settings, this.columns._state, this.options, {unhideHeader: !0})]
                                }]
                            };
                        ...
                        destroy() {
                            if (this.options.destroyable) {
                                if (this.wrapperDOM) if (this.wrapperDOM.parentElement) {
                                    const t = s("div");
